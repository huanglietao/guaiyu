...
class UsersDao extends DaoBase
{
     ...
     * 创建用户
     * @param array $data
     * @return \Illuminate\Contracts\Foundation\Application|\Illuminate\Foundation\Application|\Laravel\Lumen\Application|mixed
     * @throws JsonException
     */
    public function create(array $data)
    {
        ...
        //判断用户名是否存在
        if ($model->whereRaw(\sprintf('lower(username) = "%s" ', \strtolower($data['username'])))->exists())
        {
